...
# Objective  
The main object of the project is a model to use unsupervised learning to best segment customers into distinct categories for a wholesale distributor.

# Prerequisites  
The data and required python libraries are mentioned in the notebook customer_segments.ipynb
